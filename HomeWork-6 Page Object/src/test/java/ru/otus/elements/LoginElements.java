...
public class LoginElements {
    ...
    public static final String INPUT_LOGIN  = "//form[contains(@class,'new-log-reg__form')]/div/input[contains(@name,'email')]";
    public static final String INPUT_PASSWORD  = "//form[contains(@class,'new-log-reg__form')]/div/input[contains(@name,'password')]";
    public static final String SUBMIT_LOGIN_PAGE  = "//form[contains(@class,'new-log-reg__form')]/div/button[contains(@type,'submit')]";
